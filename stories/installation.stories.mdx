...
```sh
npm install @revivejs/react-data-table-component
```

### yarn

```sh
yarn add @revivejs/react-data-table-component
```
...
```sh
yarn add @revivejs/react-data-table-component styled-components
```
