...
For logging issues or bugs please use the [issue templates](https://github.com/alexandroit/react-data-table-component/tree/master/.github/ISSUE_TEMPLATE).

It's helpful to know the versions, steps to reproduce, and it's especially useful to have a [CodeSandbox](https://codesandbox.io/s/react-data-table-sandbox-ccyuu) when possible or at least the component code involved. The more detail you provide, the faster a fix or explanation can happen.
