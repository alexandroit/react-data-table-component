...
```js
import DataTable, { Direction } from '@revivejs/react-data-table-component';
...
```js
import DataTable, { Alignment } from '@revivejs/react-data-table-component';
...
```js
import DataTable, { Media } from '@revivejs/react-data-table-component';
